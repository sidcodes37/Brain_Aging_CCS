...
# INPUT_CSV = "/serverdata/ccshome/sid/Final Pipeline/final_outputs/04_final_train_data.csv" # CSV listing EDFs plus age,gender,filepath
# OUTPUT_CSV = "/serverdata/ccshome/sid/Final Pipeline/final_outputs/CCS_train_features.csv" # where to write the generated CCS features CSV
# THRESH_CSV = "/serverdata/ccshome/sid/Final Pipeline/final_outputs/CCS_train_thresh.csv"
# REJECT_CSV = "/serverdata/ccshome/sid/Final Pipeline/final_outputs/CCS_train_reject_log.csv"
# FAILED_LOG_CSV = "/serverdata/ccshome/sid/Final Pipeline/final_outputs/CCS_train_failed_log.csv"

INPUT_CSV = "/serverdata/ccshome/sid/subsampled_train_data_pop.csv" # CSV listing EDFs plus age,gender,filepath
OUTPUT_CSV = "/serverdata/ccshome/sid/subsampled_train_data_features.csv" # where to write the generated CCS features CSV
THRESH_CSV = "/serverdata/ccshome/sid/subsampled_train_data_thresh.csv"
REJECT_CSV = "/serverdata/ccshome/sid/subsampled_train_data_reject_log.csv"
FAILED_LOG_CSV = "/serverdata/ccshome/sid/subsampled_train_data_failed_log.csv"
# Parallelism
