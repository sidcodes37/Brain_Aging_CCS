...
OUTPUT_CSV = # Output path for file 05_C22_test_features.csv
THRESH_CSV = # Output path for file 05_C22_test_thresh.csv
REJECT_CSV = # Output path for file 05_C22_test_reject_log.csv
